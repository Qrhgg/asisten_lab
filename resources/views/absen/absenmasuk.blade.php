...
<section class="popular-courses-area section-gap courses-page">
    <div class="container">
        ...
        <div class="row">
            <div class="card-body">
                <form action="/simpanmasuk" method="post">
                    @csrf
                    <div class="form-group">
                        <center>
                            ...
                            <center>
                                ...
                                <br>
                                {{-- @if( 'realTimeClock' == $shift->jam_masuk ) --}}
                                <div class="form-group">
                                    <button type="submit" class="btn btn-primary">Klik Untuk Absen Masuk </button>
                                </div>
                                <center>
...
{{--                                    
                                <div class="form-group">
                                    <button type="submit" class="btn btn-primary" disabled>Klik Untuk Absen Masuk </button>
                                </div>
                                @endif() --}}
