  ...
  <div class="container">
      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="card card-primary card-outline">
            <div class="card-body box-profile">
              ...
              <p class="text-muted text-center">{{ $mahasiswa->id_jurusan }}</p>
              ...
              <a href="/mahasiswa/edit/{{ $mahasiswa->id }}" class="btn btn-warning btn-block"><b>Edit</b></a>
            </div>
            <!-- /.card-body -->
          </div>
          <!-- /.card -->
        ...
        <div class="col-md-9">
          ...
          <form action="{{ route('absen.filter') }}" method="GET" class="form-group" id="formFilter">
            {{ csrf_field() }}
          ...
          <div class="card">
            <div class="card-header p-2">
              <ul class="nav nav-pills">
                <li class="nav-item"><a class="" href="" data-toggle="tab">
                  Absen Mahasiswa</a></li>
