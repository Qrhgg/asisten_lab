            ...
            <div class="active-popular-carusel">
                ...
                <div class="single-popular-carusel">
                    <div class="thumb-wrap relative">
                        <div class="thumb relative">
                            <div class="overlay overlay-bg"></div>	
                            <img class="img-fluid" src="{{asset('/landing_page')}}/img/maintenance.jpg" alt="">
                        </div>
                        <div class="meta d-flex justify-content-between">
                    ...
                    <div class="details">
                        ...
                        <p>
                       {{-- Pada Saat Proses Maintenance diharapkan semua siswa datang								 --}} Khusus hari sabtu diwajibkan semua mahasiswa datang
                        </p>
                    </div>
                </div>	
